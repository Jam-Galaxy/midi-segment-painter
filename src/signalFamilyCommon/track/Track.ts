...
export default class Track {
  public id: TrackId = UNASSIGNED_TRACK_ID
  private readonly _events = new TickOrderedArray<TrackEvent>()
  // endOfTrack: number = 0
  public channel: number | undefined = undefined
  ...
  public setEvents(events: Array<TrackEvent>) {
    this._events.array.splice(0, this._events.array.length);
